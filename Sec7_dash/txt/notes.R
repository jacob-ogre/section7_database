...
comparison_message <- function() {
    x <- "Use caution when comparing federal to state spending when a state is
         selected from the menu; see 'Overview' for more information."
    return(x)
}
...
too_many_species <- function() {
    return("Please select only one species...")
}

too_many_states <- function() {
    return("Please select only one states...")
}
