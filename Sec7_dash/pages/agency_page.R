...
###############################################################################
# Agency summary "page" (tabItem) code for End. Sp. app.
agency_page <- {
    tabItem(tabName="agency_page",
            fluidRow(
                column(11,
                    box(title=tags$span(textOutput("cur_agency"), 
                                        style=make_24_bold()),
                        status=NULL,
                        solidHeader=FALSE,
                        height=NULL,
                        width=NULL,
                        textOutput("agency_date_range"),
                        helpText("This page is for examining the consultation
                                 data for one agency at a time; multi-agency
            ...
            fluidRow(
                column(3,
                    tipify(
                        valueBox(
                            ...
                            value=textOutput("agency_n_consult"),
                            color="blue",
                            icon=NULL,
                            width=NULL
                        ),
                    ...
                    tipify(
                        valueBox(
                            ...
                            value=textOutput("agency_med_time_consult"),
                            color="blue",
                    ...
                    tipify(
                        valueBox(
                            ...
                            value=textOutput("agency_n_jeop"),
                            color="red",
                    ...
                    tipify(
                        valueBox(
                            ...
                            value=textOutput("cur_agency_n_ESO"),
                            color="navy", #"light-blue",
                            icon=NULL, #icon("asterisk"),
                            width=NULL
                        ),
                ...
                column(3,
                    valueBox(
                        ...
                        value=textOutput("agency_n_formal"),
                        color="orange",
                        icon=NULL,
                        width=NULL
                    ),
                    valueBox(
                        ...
                        value=textOutput("agency_med_time_formal"),
                        color="orange",
                        icon=NULL,
                        width=NULL
                    ),
                    tipify(
                        valueBox(
                            ...
                            value=textOutput("agency_n_admod"),
                            color="red",
                            icon=icon("exclamation-circle"),
                            width=NULL
                        ),
                        title="Action will adversely modify critical habitat"
                    ),
                    tipify(
                        valueBox(
                            subtitle="Number of species consulted on",
                            value=textOutput("cur_agency_n_species"),
                            color="navy",
                            icon=NULL,
                            width=NULL
                        ),
                        title="Number of species evaluated by FWS"
                    )
                ),

                # plot the state-level spending summary figure
                column(6,
                    box(htmlOutput("agency_summary_figure"),
            ...
            fluidRow(
                column(12,
                    ...
                    box(title="Consultations by species",
                        ...
                        height=NULL,
                        width=NULL,
                        htmlOutput("agency_by_species_plot")
                    ),
                    box(title="Consultations by work category",
                        ...
                        height=NULL,
                        width=NULL,
                        htmlOutput("agency_by_work_cat_plot")
                    )
                ),
                column(6,
                    box(title="Consultations by complexity",
                        ...
                        height=NULL,
                        width=NULL,
                        htmlOutput("agency_by_complex_plot")
                    )
                ),
                column(6,
                    box(title="All vs. formal consultations",
                        ...
                        height=NULL,
                        width=NULL,
                        htmlOutput("agency_by_formal_plot")
                    )
                )
            ),
